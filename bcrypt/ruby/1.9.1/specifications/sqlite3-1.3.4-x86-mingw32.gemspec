...
Note that this module is NOT compatible with SQLite 2.x.}
  ...
  s.files = [%q{Manifest.txt}, %q{README.rdoc}, %q{CHANGELOG.rdoc}, %q{API_CHANGES.rdoc}, %q{ext/sqlite3/sqlite3.c}, %q{ext/sqlite3/backup.c}, %q{ext/sqlite3/statement.c}, %q{ext/sqlite3/database.c}, %q{ext/sqlite3/exception.c}]
