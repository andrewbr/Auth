...
Gem::Specification.new do |s|
  ...
  s.authors = [%q{James A. Rosen}, %q{Ping Yu}, %q{Michael Bleigh}, %q{Erik Michaels-Ober}, %q{Raecoo Cao}]
  s.date = %q{2011-09-22}
  s.description = %q{Enterprise strategies for OmniAuth.}
  s.email = [%q{james.a.rosen@gmail.com}, %q{ping@intridea.com}, %q{michael@intridea.com}, %q{sferik@gmail.com}, %q{raecoo@intridea.com}]
